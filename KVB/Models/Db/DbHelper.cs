...
namespace KVB.Models.Db
{
    public class DbHelper
    {
     #if DEBUG
            private static string defaultConnectionString = "Data Source=KSVLAP045;Initial Catalog=Kvb;Integrated Security=True;TrustServerCertificate=True";
     #else
